...
```sh
npm run shot        # builds the app, runs it on the fixture, eight framings into shots/
```
...
Add a framing to `scripts/shoot.sh` when you add something the existing eight
...
scripts/shoot.sh             a framing, if the eight would not reveal it
