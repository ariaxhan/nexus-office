...
- [ ] When a gate is raised, answer it once from `https://arias-macbook-pro-2.tail4f309a.ts.net/` on the iPhone.

<details><summary>Proof</summary>

Serving identity was established before live claims:

- serving repo: `/Users/slowember/Developer/Vaults/CodingVault/nexus-office`
- serving process: `client/serve.py --port 8790`, commit `4630639856693e76d900488ac59995a9703f9709`
- serving domain: `arias-macbook-pro-2.tail4f309a.ts.net`

Webhook checks:

- `tailscale cert arias-macbook-pro-2.tail4f309a.ts.net` reported the existing certificate and key unchanged inside Tailscale's app container.
...
- The running server returns 200 for `ariaxhan@gmail.com`, 403 for `timothyshin2024@gmail.com`, and 403 with no tailnet identity.
...
- The installed two-account GET-only Gmail adapter read both `aria@blinkbuild.ai` and `ariaxhan@gmail.com` successfully.
