...
curl -sS -o /dev/null -w '%{http_code}\n' https://arias-macbook-pro-2.tail4f309a.ts.net:8443/webhook
```
...
scripts/register-webhooks.sh --dry-run https://arias-macbook-pro-2.tail4f309a.ts.net:8443/webhook
scripts/register-webhooks.sh           https://arias-macbook-pro-2.tail4f309a.ts.net:8443/webhook
```
