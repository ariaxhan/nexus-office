...
# against the demo fixture, and photographs ten framings into shots/.
#
# Nine come out of one run. The tenth is a second run with --light, because
...
echo "shoot: running the nine dark framings"
shoot_run
...
MISSING=0
for framing in roster desk gate needs wall putaway automation sessions attach light; do
