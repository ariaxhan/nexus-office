...
# against the demo fixture, and photographs eighteen framings into shots/.
#
# Seventeen come out of one run. The eighteenth is a second run with --light,
...
echo "shoot: running the seventeen dark framings"
shoot_run $QUIET
...
MISSING=0
for framing in roster faces desk gate needs wall library clock pipeline context putaway automation sessions reactions readme attach settings compare light; do
