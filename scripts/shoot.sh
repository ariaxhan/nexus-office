...
# against the demo fixture, and photographs twenty-three framings into shots/.
#
# Twenty-two come out of one run. The twenty-third is a second run with --light,
...
echo "shoot: running the twenty-two dark framings"
shoot_run $QUIET
...
MISSING=0
for framing in roster faces desk gate needs home homerest wall library clock pipeline context bigger putaway feed deskfeed automation sessions reactions readme attach settings compare light; do
