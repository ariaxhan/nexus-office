...
# against the demo fixture, and photographs seven framings into shots/.
#
#   ./scripts/shoot.sh
#
...
echo "shoot: running the seven framings"
...
MISSING=0
for framing in roster desk gate needs wall putaway attach; do
