...
**Verified how:** The process list contained no nexus-office dispatcher, shot command, or Office build. A fresh `dispatch.sh --repo /Users/slowember/Developer/Vaults/CodingVault/nexus-office` reported `PARKED`, surveyed zero issues, and handled zero.
