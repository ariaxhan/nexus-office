...
- Still failing: `com.nexus.research-digest` last attempted at 2026-09-06 22:00:05 UTC and exited 1; retained `jobctl` receipt and [probe report](https://github.com/ariaxhan/nexus-office/issues/146#issuecomment-5566738385).
...
- Delivery owed: diagnose and bound the slow probe path, repair `activate-experiment` and `research-digest`, release the probe quarantine through the owning runtime, then obtain one fresh clean probe receipt before treating #146 as recovered.
