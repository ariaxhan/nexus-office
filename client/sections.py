...
from sources import care, care_grader, clock, cost, flows, library, mail, money_swarm, pipeline, podcasts, prs, webhook

SOURCES = [care, care_grader, clock, cost, flows, library, mail, money_swarm, pipeline, podcasts, prs, webhook]
