...
from sources import care, clock, cost, flows, library, mail, money_swarm, pipeline, webhook

SOURCES = [care, clock, cost, flows, library, mail, money_swarm, pipeline, webhook]
